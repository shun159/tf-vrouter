...
extern int
vr_ip_rcv(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *);
extern int
nh_output(struct vr_packet *, struct vr_nexthop *, struct vr_forwarding_md *);
...
extern nh_processing_t nh_discard(struct vr_packet *pkt,
...
static inline bool
vr_nexthop_is_being_edited(const struct vr_nexthop *nh)
{
