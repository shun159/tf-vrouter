...
extern int vr_send_interface_add(struct nl_client *,
                                 int,
                                 char *,
                                 int,
                                 int,
...
extern int vr_send_vif_clear_stats(struct nl_client *cl, unsigned int router_id, int vif_idx, int core);
...
extern int vr_send_mirror_add(struct nl_client *, unsigned int, unsigned int, int, unsigned int, int);
...
extern int vr_send_nexthop_composite_add(struct nl_client *,
                                         unsigned int,
                                         int,
                                         unsigned int,
                                         int,
                                         ...
                                         unsigned int *,
                                         unsigned int);
extern int vr_send_nexthop_encap_tunnel_add(struct nl_client *,
                                            unsigned int,
                                            unsigned int,
                                            int,
                                            unsigned int,
                                            ...
                                            int,
                                            int);
extern int vr_send_nexthop_add(struct nl_client *, unsigned int, unsigned int, int, unsigned int, int, int *, int);
extern vr_nexthop_req *vr_nexthop_req_get_copy(vr_nexthop_req *);
extern void vr_nexthop_req_destroy(vr_nexthop_req *);
extern int
vr_send_pbb_tunnel_add(struct nl_client *, unsigned int, int, unsigned int, int, int8_t *, unsigned int, unsigned int);

extern void address_mask(uint8_t *, uint8_t, unsigned int);
extern int vr_send_route_dump(struct nl_client *, unsigned int, unsigned int, unsigned int, uint8_t *);
extern int vr_send_route_get(struct nl_client *,
                             unsigned int,
                             unsigned int,
                             unsigned int family,
                             uint8_t *,
                             unsigned int,
                             uint8_t *);
extern int vr_send_route_delete(struct nl_client *,
                                unsigned int,
                                unsigned int,
                                unsigned int family,
                                uint8_t *,
                                ...
                                uint32_t,
                                unsigned ints);
extern int vr_send_route_add(struct nl_client *,
                             unsigned int,
                             unsigned int,
                             unsigned int family,
                             uint8_t *,
...
extern int vr_send_vrf_assign_set(struct nl_client *, unsigned int, unsigned int, unsigned int, unsigned int);
...
extern int vr_send_vrouter_set_logging(struct nl_client *,
                                       unsigned int,
                                       unsigned int,
                                       unsigned int *,
                                       unsigned int,
...
extern int vr_send_vrf_add(struct nl_client *, unsigned int, unsigned int, int, int, unsigned int);
...
extern int vr_send_qos_map_add(struct nl_client *,
                               unsigned int,
                               unsigned int,
                               uint8_t *,
                               uint8_t,
...
extern int
vr_send_fc_map_add(struct nl_client *, unsigned int, int16_t *, uint8_t, uint8_t *, uint8_t *, uint8_t *, uint8_t *);
...
extern int vr_send_info_dump(struct nl_client *cl,
...
extern int vr_send_vrouter_set_runtime_opts(struct nl_client *,
                                            unsigned int,
                                            int,
                                            int,
                                            int,
